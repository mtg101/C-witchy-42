...
SPRITE_MOVE_LEFT
    ...
    ldx SPR_X_EXP
    bne +
    cmp #SPRITE_WITCH_X_SML_MIN
    jmp ++
+
    cmp #SPRITE_WITCH_X_BIG_MIN
++
...
SPRITE_MOVE_RIGHT
    ...
    ldx SPR_X_EXP
    bne +
    cmp #SPRITE_WITCH_X_SML_MAX
    jmp ++
+
    cmp #SPRITE_WITCH_X_BIG_MAX
++
...
SPRITE_MOVE_UP
    ...
    ldx SPR_Y_EXP
    bne +
    cmp #SPRITE_WITCH_Y_SML_MIN
    jmp ++
+
    cmp #SPRITE_WITCH_Y_BIG_MIN
++
...
SPRITE_MOVE_DOWN
    ...
    ldx SPR_Y_EXP
    bne +
    cmp #SPRITE_WITCH_Y_SML_MAX
    jmp ++
+
    cmp #SPRITE_WITCH_Y_BIG_MAX
++
...
SPRITE_WITCH_Y_SML_MAX = 204 + (SPR_HEIGHT / 2)
